              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-4 custom-scrollbar">
                {(gameData.npcs || [])
                  ...
                  .map(({ npc, index, locStr, isUnknownLoc, isMale }) => {
                    const bgClass = isMale ? "bg-blue-500/5 hover:bg-blue-500/10" : "bg-pink-500/5 hover:bg-pink-500/10";
                    const borderClass = isMale ? "border-blue-500/20 hover:border-blue-500/30" : "border-pink-500/20 hover:border-pink-500/30";
                    const iconBgClass = isMale ? "bg-blue-500/10" : "bg-pink-500/10";
                    const iconBorderClass = isMale ? "border-blue-500/20" : "border-pink-500/20";
                    const textClass = isMale ? "text-blue-400" : "text-pink-400";

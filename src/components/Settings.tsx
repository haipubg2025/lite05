...
export default function Settings() {
  ...
  const [proxyForm, setProxyForm] = useState({ url: '', key: '' });
    ...
    <div className="p-6 md:p-12 lg:p-16 pb-32 md:pb-16 w-full h-full overflow-y-auto custom-scrollbar">
      ...
      >
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-16 px-4">
          ...
          {/* Navigation Tabs */}
          <div className="flex p-1.5 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md self-start md:self-center">
            {tabs.map((tab) => {
              ...
              return (
                <button
                  ...
                  className={`px-6 py-2.5 rounded-xl text-sm font-bold flex items-center gap-2 transition-all relative cursor-pointer ${
                    isActive ? currentTheme.textPrimary : 'text-white/40 hover:text-white/70'
                  }`}
                >
                  {isActive && (
                    <motion.div
              ...
              <section className="w-full space-y-12">
                <div className="p-8 rounded-[2.5rem] bg-white/5 border border-white/10 backdrop-blur-xl">
                  ...
                  <div className="space-y-6">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 rounded-2xl bg-black/20 border border-white/5 gap-4">
                      <div>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <button
                          ...
                          className={`px-4 py-2 rounded-xl text-sm font-bold flex items-center gap-2 transition-colors border border-white/10 hover:bg-white/5 cursor-pointer disabled:opacity-50 ${currentTheme.textPrimary}`}
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 rounded-2xl bg-black/20 border border-white/5 gap-4">
                      ...
                      <select 
                        ...
                        className="bg-black/40 border border-white/10 rounded-xl px-4 py-2 text-white outline-none focus:border-blue-500 min-w-[200px] text-sm [&>option]:bg-black [&>option]:text-white"
                      >
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 rounded-2xl bg-black/20 border border-white/5 gap-4">
                      ...
                      <select 
                        ...
                        className="bg-black/40 border border-white/10 rounded-xl px-4 py-2 text-white outline-none focus:border-blue-500 min-w-[180px] [&>option]:bg-black [&>option]:text-white"
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex gap-2">
                          <input 
                            ...
                            className="flex-1 px-5 py-4 rounded-xl bg-black/20 border border-white/5 text-white outline-none focus:border-purple-500/50 transition-colors text-sm"
                          />
                          <button
                            onClick={() => {
                ...
                <section className="space-y-8">
                        ...
                        <div className="space-y-4">
                          <div className="space-y-2 text-left">
                            ...
                            <input 
                              ...
                              className="w-full px-5 py-4 rounded-xl bg-black/40 border border-white/5 focus:border-blue-500/50 text-blue-400 outline-none text-sm font-mono transition-colors"
                            />
                          </div>
                          <div className="space-y-2 text-left">
                            ...
                            <input 
                              ...
                              className="w-full px-5 py-4 rounded-xl bg-black/40 border border-white/5 focus:border-blue-500/50 text-white/70 outline-none text-sm font-mono transition-colors"
                            />
                          </div>
                          ...
                          <div className="space-y-2 text-left">
                            ...
                            <select
                              ...
                              className="w-full px-5 py-4 rounded-xl bg-black/40 border border-white/5 focus:border-blue-500/50 text-white outline-none text-sm font-mono transition-colors [&>option]:bg-black [&>option]:text-white"
                            >
                      ...
                      <div className="space-y-4">
                        <div className="space-y-2 text-left">
                          ...
                          <input 
                            ...
                            className="w-full px-5 py-4 rounded-xl bg-black/20 border border-white/5 text-white outline-none focus:border-blue-500/50 transition-colors text-sm font-mono"
                          />
                        </div>
                        <div className="space-y-2 text-left">
                  ...
                  <div className="flex gap-4 pt-4 border-t border-white/10 mt-6">
                    <button 
                      ...
                      className="flex-1 py-3 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 text-white text-sm font-bold transition-all flex items-center justify-center gap-2 cursor-pointer"
                    >
                      <Download className="w-4 h-4" /> Xuất JSON
                    </button>
                    <label className="flex-1 py-3 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 text-white text-sm font-bold transition-all flex items-center justify-center gap-2 cursor-pointer group text-center">

...
Dữ liệu trả về PHẢI là một object JSON duy nhất với cấu trúc chính xác sau (Lưu ý: MC và NPC phải có đầy đủ các trường thông tin chi tiết):
{
  ...
  "mcData": { 
    "name": "Tên gọi ngắn gọn",
    "fullName": "Họ và tên đầy đủ",
    "titles": "Danh xưng/Tước hiệu (nếu có)",
    "occupation": "Chức vụ/Nghề nghiệp hiện tại",
    "gender": "Giới tính",
    "age": "Tuổi tác (con số cụ thể)",
    "dob": "Ngày tháng năm sinh chi tiết",
    "height": "Chiều cao cụ thể",
    "weight": "Cân nặng cụ thể",
    "measurements": "Số đo 3 vòng (Đặc biệt với nữ giới bắt buộc chi tiết, ví dụ: 90-60-90 Cup D) hoặc Đặc trưng hình thể",
    "appearance": "Miêu tả ngoại hình bẩm sinh, khuôn mặt, đôi mắt, mái tóc, phong thái tổng quan (Không tả trạng thái lâm thời)",
    "background": "Nguồn gốc, xuất thân, quá khứ (Chỉ kể những gì thuộc về quá khứ, cấm spoil tương lai)",
    "rank": "Cảnh giới/Cấp độ sức mạnh hiện tại (nếu có)",
    "powers": "Năng lực, sức mạnh, hệ thống (nếu có yêu cầu)",
    "skills": "Kỹ năng chuyên môn, biệt tài",
    "personality": "Tính cách thể hiện ra bên ngoài (hoạt bát, lạnh lùng, v.v.)",
    "personalityCore": "Bản ngã cốt lõi thực sự sâu bên trong tâm hồn",
    "philosophy": "Kim chỉ nam, lý tưởng sống định hướng hành động",
    "goal": "Mục tiêu tối thượng đang theo đuổi",
    "distinguishingFeatures": "Đặc điểm nhận dạng phụ (vết sẹo, hình xăm, v.v.)",
    "innerSecret": "Bí mật nội tâm, động cơ ẩn giấu kín",
    "relationships": "Các mối quan hệ thân thiết TRONG QUÁ KHỨ VÀ HIỆN TẠI (Nhấn mạnh: Nếu mới xuyên không/Isekai thì chưa có quan hệ với người bản địa)",
    "loveViews": "Quan niệm, triết lý về tình yêu và tình dục",
    "experience": "Lịch sử tình trường, kinh nghiệm NSFW (còn trinh/mất trinh, trong sáng hay từng trải)",
    "nsfwPersonality": "Tính cách bộc lộ khi rơi vào các tình huống NSFW/ân ái (chủ động, cuồng nhiệt hay nhút nhát)",
    "nsfwReactions": "Phản ứng đặc trưng cơ thể và lời nói khi bị kích thích NSFW",
    "literaryDescription": "Chân dung văn học đoạn văn tả lại toàn bộ con người MC",
    "inventory": "Tài sản, tiền bạc, vật phẩm mang theo trong túi lúc bấy giờ"
  },
  "npcs": [{ 
      "name": "Tên gọi ngắn gọn", 
      "fullName": "Họ và tên đầy đủ", 
      "titles": "Danh xưng/Tước hiệu/Biệt danh", 
      "occupation": "Chức vụ/Nghề nghiệp/Vị trí xã hội", 
      "gender": "Giới tính", 
      "age": "Tuổi tính bằng số", 
      "dob": "Ngày tháng năm sinh cụ thể", 
      "height": "Chiều cao chi tiết", 
      "weight": "Cân nặng chi tiết", 
      "measurements": "Số đo 3 vòng (Nữ giới bắt buộc chi tiết) hoặc Đặc trưng cơ bắp/hình thể", 
      "appearance": "Diện mạo bẩm sinh (mắt, tóc, nét mặt, phong thái. Cấm tả trạng thái lâm thời)", 
      "background": "Tuổi thơ, xuất thân, lai lịch (Cấm spoil tương lai)", 
      "rank": "Cấp bậc sức mạnh/Cảnh giới hiện tại", 
      "powers": "Năng lực đặc dị/Sức mạnh bẩm sinh", 
      "skills": "Kỹ năng chuyên môn trong cuộc sống",
      "role": "Vai trò chức năng của họ trong cốt truyện", 
      "relation": "Quan hệ cụ thể với MC ở thời điểm HIỆN TẠI (Nếu MC Isekai thì chưa quen biết)",
      "personality": "Tính cách biểu hiện ra ngoài",
      "personalityCore": "Bản ngã thâm sâu, bản chất thực sự của linh hồn", 
  ...
  "worldDetails": { "places": "Mô tả chi tiết các địa điểm quan trọng bước đầu", "items": "Mô tả các vật phẩm quan trọng có sẵn" }
}`;
      ...
      try {
        ...
        if (jsonMatch) {
          ...
          toast.success('Matrix Lite v2 đã sẵn sàng!');
        }
      } catch (parseError) {
